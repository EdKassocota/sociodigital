...
export default function Atuacao() {
  ...
  return (
    <section ref={containerRef} id="atuacao" className="min-h-screen flex items-center relative bg-white overflow-hidden grid-pattern">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="w-full relative">
            <motion.div
              ...
              className="relative aspect-[4/5] rounded-xl overflow-hidden shadow-2xl shadow-brand-dark/5 max-h-[60vh]"
            >
              <img
                src="/imgs/img8.jpg"
          ...
          <div className="flex flex-col justify-center">
            ...
            >
              <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-medium tracking-tight text-brand-dark mb-8">
            ...
            <ul className="space-y-4 md:space-y-6">
              {atuacaoItems.map((item, index) => (
                ...
                >
                  <Link to={`/servicos#${item.id}`} className="flex items-center gap-4 w-full">
                    ...
                    <span className="font-sans text-lg md:text-xl text-brand-dark/80 font-medium tracking-wide group-hover:text-brand-dark transition-colors duration-300">
                      {item.title}
                    </span>
                  </Link>
                </motion.li>
